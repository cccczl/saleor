...
def get_gateway_operation_func(gateway, operation_type):
    ...
    elif operation_type == OperationType.CAPTURE:
        return gateway.capture
    elif operation_type == OperationType.CHARGE:
        return gateway.charge
    elif operation_type == OperationType.VOID:
        return gateway.void
    elif operation_type == OperationType.REFUND:
...
def gateway_authorize(payment: Payment, payment_token: str) -> Transaction:
    ...
    return call_gateway(
        operation_type=OperationType.AUTH, transaction_kind=TransactionKind.AUTH,
